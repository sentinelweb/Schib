package uk.co.sentinelweb.schibsted.net;
...
import uk.co.sentinelweb.schibsted.Const;
import uk.co.sentinelweb.schibsted.net.services.RecipeService;

/**
 * This manages the retrofit instance and request cache.
 * <p/>
 * And can bue used o build retrofit service instances. (e.g. {@link #getRecipeService()})
